    ...
    <div id="file_browser">
        ...
        <c:forEach var="lecture" items="${lectures}">
            <div id="document_item">
                ...
                <div id="join_icon" onclick="window.open('${context}/course/chat','TnL Chat', 'width=825,height=760,innerHeight=760,scrollbars=no,toolbar=no,location=no'); return false" >
                </div>
            </div>
        </c:forEach>
    </div>
